        ...
        <div class="popup__body">
            ...
            <table class="table-data style2-1 mt20">
                ...
                <tr>
                    ...
                    <th>발주금액</th>
                    <td>
                        <span class="color-primary">{{ number_format($order->order_amount) }}원</span>
                    </td>
                </tr>
                <tr>
                    <th>상품이미지</th>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <span class="color-primary">
                            {{ optional($order->delivery_date)->format('Y년 m월 d일') }}
                            @if($order->delivery_hour !== null && $order->delivery_minute !== null)
                                {{ str_pad($order->delivery_hour, 2, '0', STR_PAD_LEFT) }}:{{ str_pad($order->delivery_minute, 2, '0', STR_PAD_LEFT) }}
                            @endif
                            @if($order->delivery_time_type)
                                {{ $order->delivery_time_type }} 까지
                            @else
                                까지
                            @endif
                        </span>
