<div id="order-list-content">
    ...
    <section class="mt30">
        <form method="GET" action="{{ route('order-list') }}" id="order-filter-form">
            <table class="table-data style2">
                ...
                <tr>
                    ...
                    <td colspan="5">
                        ...
                        <span class="color-orange">발주</span>하여
                        {{ number_format($summaryAmount) }}원이 지불 되었습니다.
                    </td>
                </tr>
                <tr>
                    <th>부가설명</th>
