...
@section('content')
    <div id="content__body" style="position:relative">
        ...
        <section class="mb20">
            <h2 class="tt2">✔️ 정직한플라워 마케팅 지원센터 <small>지역카페 바이럴 마케팅</small></h2>
        </section>
        ...
        <div id="marketingCenter">
            ...
            <section class="headBox --green">
                <div class="flex">
                    <div class="flex__col">
                        <span class="fw600">지역카페 바이럴 마케팅,</span> <span class="fw500">어떤 것이 궁금하신가요?</span>
                    </div>
                    <div class="flex__col">
                ...
                <table class="table style2 mt20">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-center">100,000원</td>
